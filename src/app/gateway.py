...
from src.cloud.connector import Connector
from src.communication.protocol_creator import create_protocol
from src.config.config import SETTINGS_BASE_PATH, CLOUDIO_MODEL_DIR
...
class Gateway(metaclass=Singleton):
    """Gateway class : representing the whole gateway => creating all instances and connecting them
        ...
        * gateway_config : gateway config file content
